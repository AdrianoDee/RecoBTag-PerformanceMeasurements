...
if options.reco == 'HLT_GRun':
    ...
    process = customiseRun3BTagRegionalTracks(process)
else:
...
if options.runTiming:
    ...
    process.FastTimerService.jsonFileName = cms.untracked.string('timing_' + options.reco + '_' + str(options.maxEvents) + '.json')

interestingPath = "MC_PFBTagDeepCSV_v10"#"MC_ROIPFBTagDeepCSV_v10"
from FWCore.ParameterSet.Utilities import moduleLabelsInSequences
print(moduleLabelsInSequences(getattr(process, interestingPath)))
